...
const Result = () => {
    ...
    const handleDragStop = (e, data) => {
        ...
        // Navigate if the drag distance is minimal (click) or if it's a small screen
        if (distanceMoved < 5 || !isSmallScreen) {
    ...
    const handleClick = () => {
        // Navigate directly on click for both big and small screens
        navigate('/major_test/view_result/result/more_major_that_fit_you');
    };
